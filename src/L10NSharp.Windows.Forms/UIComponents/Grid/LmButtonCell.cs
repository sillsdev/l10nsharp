...
{
	#region LmButtonCell class
	/// ----------------------------------------------------------------------------------------
	public class LmButtonCell : DataGridViewTextBoxCell
	{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public LmButtonColumn OwningButtonColumn
		{
			get
			{
				...
				return (DataGridView.Columns[ColumnIndex] as LmButtonColumn);
			}
		}
		...
		protected override void OnMouseClick(DataGridViewCellMouseEventArgs e)
		{
			...
			LmButtonColumn col =
				DataGridView.Columns[ColumnIndex] as LmButtonColumn;
		...
		private void DrawButton(Graphics g, Rectangle rcbtn)
		{
			...
			if (buttonStyle == LmButtonColumn.ButtonType.MinimalistCombo)
				DrawMinimalistButton(g, rcbtn);
			else
			{
				if ((buttonStyle == LmButtonColumn.ButtonType.VisualStyleCombo ||
					buttonStyle == LmButtonColumn.ButtonType.VisualStylePush) &&
		...
		public void GetRectangles(Rectangle bounds, out Rectangle rcbtn, out Rectangle rcText)
		{
			...
			bool paintComboButton = (OwningButtonColumn == null ? false :
				OwningButtonColumn.ButtonStyle != LmButtonColumn.ButtonType.PlainPush &&
				OwningButtonColumn.ButtonStyle != LmButtonColumn.ButtonType.VisualStylePush);
