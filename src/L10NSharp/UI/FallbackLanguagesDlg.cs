...
namespace L10NSharp.UI
{
	...
	public partial class FallbackLanguagesDlg : Form
	{
		...
		public FallbackLanguagesDlg()
		{
			...
			_listBoxAvailableLanguages.Items.AddRange(LocalizationManager.GetUILanguages(false).ToArray());
			...
			foreach (var langId in LocalizationManager.FallbackLanguageIds)
