namespace Localization.UI
{
	partial class ShortcutKeysEditor
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnOK.Text = "OK";
			this.btnOK.DrawBackground += new XButton.DrawBackgroundHandler(this.HandleDrawButtonBackground);
			...
			this.btnReset.DrawBackground += new XButton.DrawBackgroundHandler(this.HandleDrawButtonBackground);
			this.btnReset.Click += new System.EventHandler(this.HandleResetButtonClick);
			// 
			// ShortcutKeysEditor
			// 
