...
{
	internal static class TMXXmlSerializationHelper
	{
		#region TMXmlReader class
		/// ------------------------------------------------------------------------------------
		/// <summary>
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		private class TMXmlReader : XmlTextReader
		{
			private readonly bool m_fKeepWhitespaceInElements;

			/// --------------------------------------------------------------------------------
			/// <summary>
			/// Initializes a new instance of the <see cref="TMXmlReader"/> class.
			/// </summary>
			...
			/// --------------------------------------------------------------------------------
			public TMXmlReader(TextReader reader, bool fKeepWhitespaceInElements) :
				base(reader)
			{
			...
			/// these elements will be ignored during a deserialization.</param>
			/// --------------------------------------------------------------------------------
			public TMXmlReader(string filename, bool fKeepWhitespaceInElements) :
			...
			out Exception e) where T : class
		{
			...
			try
			{
				...
				using (TMXmlReader reader = new TMXmlReader(
