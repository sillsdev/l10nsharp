...
namespace L10NSharp.TMXUtils
{
	...
	/// ----------------------------------------------------------------------------------------
	[XmlRoot("tmx")]
	public class TMXDocument: IDocument
	{
		/// ------------------------------------------------------------------------------------
		/// <summary>
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public TMXTransUnit GetTransUnitForId(string id)
		{
			return Body.GetTransUnitForId(id);
		}

		/// ------------------------------------------------------------------------------------
		public IEnumerable<TMXTransUnit> GetTransUnitsForTextInLang(string langId, string text)
		{
		...
		{
			return Body.AddTransUnit(tu as TMXTransUnit);
		}
		...
		{
			Body.RemoveTransUnit(tu as TMXTransUnit);
		}
		...
		/// </summary>
		 public TMXTransUnit GetTransUnitForOrphan(TMXTransUnit orphan)
		{
