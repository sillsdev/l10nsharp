...
namespace L10NSharp.Windows.Forms
{
	...
	public class L10NSharpExtender : Component, IExtenderProvider, ISupportInitialize
	{
		...
		private Dictionary<object, LocalizingInfoWinforms> m_extendedCtrls;
		...
		public L10NSharpExtender()
		{
			...
			m_extendedCtrls = new Dictionary<object, LocalizingInfoWinforms>();
		}
		...
		{
			var locInfo = new LocalizingInfoWinforms(e.Column, true);
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		private LocalizingInfoWinforms GetLocalizedComponentInfo(IComponent component, bool initTextFromCompIfNewlyCreated)
		{
			LocalizingInfoWinforms loi;
			...
			loi = new LocalizingInfoWinforms(component, initTextFromCompIfNewlyCreated);
			m_extendedCtrls[component] = loi;
			return loi;
		}
