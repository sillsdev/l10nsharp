...
{
	/// ----------------------------------------------------------------------------------------
	public class LmButtonColumn : DataGridViewColumn
	{
		...
		/// ------------------------------------------------------------------------------------
		public LmButtonColumn() : base(new LmButtonCell())
		{
		...
		/// ------------------------------------------------------------------------------------
		public LmButtonColumn(string name) : this()
		{
			Name = name;
		}

		/// ------------------------------------------------------------------------------------
		public LmButtonColumn(string name, bool showButton) : this()
		{
			Name = name;
		...
		public override DataGridViewCell CellTemplate
		{
			...
			set
			{
				if (value != null && !value.GetType().IsAssignableFrom(typeof(LmButtonCell)))
