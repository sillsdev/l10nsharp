...
namespace L10NSharp.XLiffUtils
{
	...
	public class TransUnit : XLiffBaseWithNotesAndProps
	{
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Gets or sets the priority value.  This is an enumeration which defaults to "DontCare",
		/// but we treat it like a string to more gracefully handle "creative" users.
		/// </summary>
		/// <remarks>This appears to not be used in the Bloom TMX files.</remarks>
		/// ------------------------------------------------------------------------------------
