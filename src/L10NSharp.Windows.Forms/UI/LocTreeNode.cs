...
namespace L10NSharp.Windows.Forms.UI
{
	...
	internal class LocTreeNode<T> : TreeNode
	{
		...
		internal ILocalizationManagerInternalWinforms<T> Manager { get; private set; }
		internal Dictionary<string, LocalizingInfoWinforms> SavedTranslationInfo { get; private set; }
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		internal LocTreeNode(ILocalizationManagerInternalWinforms<T> manager, string text, string id, string key)
		{
			Manager = manager;
			Text = text;
			Id = id;
			...
			SavedTranslationInfo = new Dictionary<string, LocalizingInfoWinforms>();
		}
